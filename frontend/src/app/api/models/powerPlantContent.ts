...
export const powerPlantContent = "powerPlant {electricityConsumption electricityProduction modelledElectricitySellPrice modelledElectricityBuyPrice electricitySellPrice electricityBuyPrice hasBlackout " + batteryContent + geoDataContent + generatorsContent + "}";
