...
|2020-12-31| 7 | Continued working on the report, worked a bit with error handling for API calls to the simulator  and started with documentation for the API.
