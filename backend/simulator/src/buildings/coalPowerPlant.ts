...
import { AVERAGE_COAL_POWER_PLANT_ELECTRICITY_CONSUMPTION_PER_SECOND } from '../utils/realLifeData'
...
export class CoalPowerPlant extends BasePowerPlant{
	...
	public calculateConsumption(deltaTimeS: number): void {
		...
		this.electricityConsumption =
			AVERAGE_COAL_POWER_PLANT_ELECTRICITY_CONSUMPTION_PER_SECOND // Average consumption/second
